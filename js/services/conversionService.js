...
this.outerConversion = function(num, typeFrom, typeTo) {
    ...
    switch(typeFrom) {
			...
			case 'teaspoon':
				if(typeTo === 'teaspoon') conversionFactor = 1;
				else if(typeTo === 'tablespoon') conversionFactor = 0.333333;
			...
			case 'tablespoon':
				if(typeTo === 'tablespoon') conversionFactor = 1;
        else if(typeTo === 'teaspoon') conversionFactor = 3;
      ...
      case 'cup':
				if(typeTo === 'cup') conversionFactor = 1;
        else if(typeTo === 'teaspoon') conversionFactor = 48.6922;
      ...
      case 'fluid ounce':
				if(typeTo === 'fluid ounce') conversionFactor = 1;
        else if(typeTo === 'teaspoon') conversionFactor = 6;
      ...
      case 'pint':
				if(typeTo === 'pint') conversionFactor = 1;
        else if(typeTo === 'teaspoon') conversionFactor = 96;
      ...
      case 'quart':
				if(typeTp === 'quart') conversionFactor = 1;
        else if(typeTo === 'teaspoon') conversionFactor = 192;
      ...
      case 'gallon':
				if(typeTo === 'gallon') conversionFactor = 1;
        else if(typeTo === 'teaspoon') conversionFactor = 768;
	...
	//Distance Conversions
			...
			case 'inch':
				if(typeTo === 'inch') conversionFactor = 1;
				else if(typeTo === 'feet') conversionFactor = .0833333;
			...
			case 'feet':
				if(typeTo === 'feet') conversionFactor = 1;
				else if(typeTo === 'inch') conversionFactor = 12;
			...
			case 'yard':
				if(typeTo === 'yard') conversionFactor = 1;
				else if(typeTo === 'inch') conversionFactor = 36;
			...
			case 'mile':
				if(typeTo === 'mile') conversionFactor = 1;
				else if(typeTo === 'inch') conversionFactor = 63360;
			...
			case 'millimeter':
				if(typeTo === 'millimeter') conversionFactor = 1;
				else if(typeTo === 'inch') conversionFactor = 0.0393701;
			...
			case 'centimeter':
				if(typeTo === 'centimeter') conversionFactor = 1;
				else if(typeTo === 'inch') conversionFactor = 0.393701;
			...
			case 'meter':
				if(typeTo === 'meter') conversionFactor = 1;
				else if(typeTo === 'inch') conversionFactor = 39.3701;
			...
			case 'kilometer':
				if(typeTo === 'kilometer') conversionFactor = 1;
				else if(typeTo === 'inch') conversionFactor = 39370.1;
		...
		//Science Conversions
			...
			case 'ounce':
				if(typeTo === 'ounce') conversionFactor = 1;
				else if(typeTo === 'pound') conversionFactor = .0625;
			...
			case 'pound':
				if(typeTo === 'pound') conversionFactor = 1;
				else if(typeTo === 'ounce') conversionFactor = 16;
			...
			case 'stone':
				if(typeTo === 'stone') conversionFactor = 1;
				else if(typeTo === 'ounce') conversionFactor = 224;
			...
			case 'gram':
				if(typeTo === 'gram') conversionFactor = 1;
				else if(typeTo === 'ounce') conversionFactor = 0.035274;
			...
			case 'kilogram':
				if(typeTo === 'kilogram') conversionFactor = 1;
				else if(typeTo === 'ounce') conversionFactor = 35.274;
		...
		//Currency Conversions
			...
			case 'penny':
				if(typeTo === 'penny') conversionFactor = 1;
				else if(typeTo === 'nickel') conversionFactor = 0.2;
			...
			case 'nickel':
				if(typeTo === 'nickel') conversionFactor = 1;
				else if(typeTo === 'penny') conversionFactor = 5;
			...
			case 'dime':
				if(typeTo === 'dime') conversionFactor = 1;
				else if(typeTo === 'penny') conversionFactor = 10;
			...
			case 'quarter':
				if(typeTo === 'quarter') conversionFactor = 1;
				else if(typeTo === 'penny') conversionFactor = 25;
			...
			case 'halfDollar':
				if(typeTo === 'halfDollar') conversionFactor = 1;
				else if(typeTo === 'penny') conversionFactor = 50;
			...
			case 'dollar':
				if(typeTo === 'dollar') conversionFactor = 1;
				else if(typeTo === 'penny') conversionFactor = 100;
